...
const onSearchAnalysisCategoryChange = throttle(function (term) {
    router.get(route('counteranalysis.create'), {term}, {
    preserveState: true,
    preserveScroll: true,
    replace: true
    })
...
if(!form.id) {
  form.post(route('counteranalysis.store'), {
      onSuccess: () => {
        form.reset()
      },
  });
    ...
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-10">
          ...
          <div class="sm:col-span-2 sm:col-start-1">
            <label for="collection_date" class="block text-sm font-medium leading-6 text-gray-900">Data da Colheita</label>
            <div class="mt-2">
          ...
          <div class="sm:col-span-4">
            <label for="price" class="block text-sm font-medium leading-6 text-gray-900">Colaborações</label>
            <div class="mt-2">
      ...
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base font-semibold leading-7 text-gray-900 flex items-center">
          {{ form.products.length }} Produtos
          <button @click="addProduct" class="hover:text-blue-900 transform transition-all duration-200 hover:scale-150 ml-auto">
            <PlusCircleIcon class="h-5 w-5" />
          </button>
        </h2>
        <p class="mt-1 text-sm leading-6 text-gray-600">Produtos associados ao cliente: {{ form.customer_id.label }}</p>
        ...
        >
          ...
          <dl class="-my-3 divide-y divide-gray-100 px-6 py-4 text-sm leading-6">
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label for="product_id" class="block text-sm font-medium leading-6 text-gray-900">Produto</label>
                  <div class="mt-2">
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label for="expiry_date" class="block text-sm font-medium leading-6 text-gray-900">Data de Expiração</label>
                  <div class="mt-2">
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label for="pack_id" class="block text-sm font-medium leading-6 text-gray-900">Embalagem</label>
                  <div class="mt-2">
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label for="temperature_id" class="block text-sm font-medium leading-6 text-gray-900">Temperatura</label>
                  <div class="mt-2">
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label for="result_id" class="block text-sm font-medium leading-6 text-gray-900">Finalidade</label>
                  <div class="mt-2">
