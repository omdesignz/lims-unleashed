        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-4">
                <h2 class="text-lg font-semibold text-white flex items-center gap-2">
                    ...
                    {{ $t('gestlab.general.labels.credit_notes.credit_note_settings') }}
                </h2>
            </div>
            <div class="p-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-gray-900">
                                    {{ $t('gestlab.general.labels.credit_notes.invoice_by_matrix') }}
                                </h3>
            ...
            <div class="border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        ...
                        {{ $t('gestlab.general.labels.credit_notes.items') }}
                ...
                <p class="mt-1 text-sm text-gray-600">
                    {{ $t('gestlab.general.labels.credit_notes.items_tagline') }}
                </p>
            </div>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="py-3.5 pl-6 pr-3 text-left text-sm font-semibold text-gray-900">
                                {{ $t('gestlab.general.labels.credit_notes.item_id') }}
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                                {{ $t('gestlab.general.labels.credit_notes.qty') }}
                            </th>
                            ...
                            <th scope="col" class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">
                                {{ $t('gestlab.general.labels.credit_notes.total') }}
                            </th>
            ...
            <div class="text-sm text-gray-500">
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-2">
                        ...
                        <span>{{ form.items.length }} {{ $t('gestlab.general.labels.credit_notes.items') }}</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <!-- <CurrencyEuroIcon class="h-4 w-4 text-gray-400" /> -->
                                    <p class="text-gray-400 mr-2">AOA</p>

                        <span class="font-semibold">{{ noteTotal }} {{ $t('gestlab.general.labels.credit_notes.total') }}</span>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-4">
