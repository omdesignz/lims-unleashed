...
import equipmentExportForm from "@/Pages/InventoryItems/equipments-export.vue";
...
const exportInventory = () => {
  axios.get(route('iitems.export-inventory'), {
    params: exportParams,
  }).then((response) => {
...
const deleteAttachment = (model_id, id, index) => {
      ...
      deleteForm.delete(route('iitems.delete-attachment', {model_id: model_id, id: id}), {
          preserveScroll: true,
          preserveState: false,
          onSuccess: () => {
...
let submit = () => {
  if (!form.id) {
    ...
    form.post(route("iitems.update", { iitem: form.id, _method: 'PUT' }), {
      preserveScroll: true,
      preserveState: false,
      onError: () => {
            showDeleteConfirmationSlideover.value = false
...
const loadItemStatuses = async (query = "") => {
  if(categoryId.value) {
    const response = await fetch("/itemstatuses/getItemStatus?q=" + query + "&category_id=" + categoryId.value);
...
const downloadAttachment = (file) => {
      console.log(file);
        axios.get(route('iitems.download-single-attachment', {
            model_id: file.id
        })).then(response => {
...
<template>
  <div class="border-b border-gray-200 pb-5">
    <h3 class="text-base font-semibold leading-6 text-gray-900">
      {{ $t("gestlab.general.labels.iitems.page_title") }}
    </h3>
  ...
  <template #actions="{ id }">
      <Link
                    :href="route('iitems.show', {iitem: id})"
        ...
        >
          <div>
            <label
              ...
              >{{ $t("gestlab.general.labels.iitems.category_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
              ...
              @update:modelValue="categoryId = $event.value"
            />
            <p
        ...
        >
          <div>
            <label
              for="eq_cat_id"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.eq_cat_id") }}</label
            > 
          </div>
          <div class="sm:col-span-2">
            <combobox
        ...
        >
          <div>
            <label
              for="name"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.name") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="brand"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.brand") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="location"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.location") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="department_id"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.department_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
        ...
        >
          <div>
            <label
              for="model"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.model") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="software"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.software") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="firmware"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.firmware") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="internal_code"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.internal_code") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="range"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.range") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="precision"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.precision") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="resolution"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.resolution") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="code"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.code") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="barcode"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.barcode") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="serial_number"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.serial_number") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{
                $t("gestlab.general.labels.iitems.last_calibration_date")
              }}</label
            >
          </div>
          <div class="sm:col-span-2">
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{
                $t("gestlab.general.labels.iitems.next_calibration_date")
              }}</label
            >
          </div>
          <div class="sm:col-span-2">
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.reagent_open_date") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <date-picker
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.reagent_expiry_date") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <date-picker
        ...
        >
          <div>
            <label
              for="unit_id"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.unit_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
        ...
        >
          <div>
            <label
              for="type_id"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.type_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
        ...
        >
          <div>
            <label
              for="lot"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.lot") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.acceptance_criteria") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="supplier_id"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.supplier_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
          ...
          > 
            <div>
              <label
                for="user_id"
                class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
                >{{ $t("gestlab.general.labels.iitems.user_id") }}</label
              > 
            </div>
            <div class="sm:col-span-2">
        ...
        >
          <div>
            <label
              for="description"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.description") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <textarea
        ...
        >
          <div>
            <label
              for="obs"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.obs") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <textarea
        ...
        >
          <div>
            <label
              for="refrigerated"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.refrigerated") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="status"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.status_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.has_safety_documentation") }}</label
            >
          </div>
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packaging_type_id") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <combobox
        ...
        >
          <div>
            <label
              for="reorder_qty"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.reorder_qty") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="packed_weight"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_weight") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_weight_unit") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="packed_height"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_height") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_height_unit") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="packed_width"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_width") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              ...
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_width_unit") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
        ...
        >
          <div>
            <label
              for="packed_depth"
              class="block text-sm font-medium leading-6 text-gray-900 sm:mt-1.5"
              >{{ $t("gestlab.general.labels.iitems.packed_depth") }}</label
            >
          </div>
          <div class="sm:col-span-2">
            <input
          ...
          <dl class="divide-y divide-gray-100">
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.category_id") }}
              </dt>
              <dd
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 1">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.eq_cat_id") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.name") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0 sm:py-5">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.department_id") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.code") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.barcode") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 1">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.serial_number") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div v-if="form.category_id?.value === 2" class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.reagent_open_date") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div v-if="form.category_id?.value === 2" class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.reagent_expiry_date") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.unit_id") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.description") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div v-if="form.category_id?.value === 2" class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.obs") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 1">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.type_id") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <!-- Lot -->
             <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.lot") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.acceptance_criteria") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.refrigerated") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.reorder_qty") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.packed_weight") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.packed_height") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.packed_width") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" v-if="form.category_id?.value === 2">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.packed_depth") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt class="text-sm font-medium leading-6 text-gray-900">
                {{ $t("gestlab.general.labels.iitems.status_id") }}
              </dt>
              <dd
                class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
              >
