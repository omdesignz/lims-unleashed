      ...
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            {{ $t('gestlab.general.labels.maintenance_tasks.update_title') }}
          </h1>
          <p class="mt-2 text-sm text-gray-600">
            {{ $t('gestlab.general.labels.maintenance_tasks.update_description') }}
          </p>
        </div>
...
const form = useForm({
  ...
  equipment_id: {
    value: props.record.data?.equipment_id,
    label: props.record.data?.equipment
  },
  due_date: props.record.data?.due_date,
  previous_date: props.record.data?.previous_date,
  next_date: props.record.data?.next_date,
  acceptance_criteria: props.record.data?.acceptance_criteria,
  range: props.record.data?.range,
  calibration_status: props.record.data?.calibration_status,
  calibration_certificate_no: props.record.data?.calibration_certificate_no,
  periodicity: props.record.data?.periodicity,
  periodicity_unit: props.periodicityUnits.data.find(unit => unit.value === props.record.data?.periodicity_unit) || { value: props.record.data?.periodicity_unit, label: props.record.data?.periodicity_unit, },
  executed_by_supplier: props.record.data?.executed_by_supplier,
  supplier_id: {
    value: props.record.data?.supplier_id,
    label: props.record.data?.supplier
  },
  obs: props.record.data?.obs,
  cost: props.record.data?.cost,
  is_planned: props.record.data?.is_planned,
  is_executed: props.record.data?.is_executed,
  calibration_points: props.record.data?.calibration_points,
  result: props.record.data?.result,
})
