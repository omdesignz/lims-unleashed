      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-2 text-gray-600">
            {{ $t('gestlab.general.labels.export_certificates.page_update_description') }}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="space-y-2">
            ...
            <comboboxEnhanced 
              ...
              placeholder="Seleccione o exportador..."
            />
          ...
          <div class="space-y-2">
            ...
            <comboboxEnhanced 
              ...
              placeholder="Seleccione o tipo de transporte..."
            />
          ...
          <div class="mt-4">
            ...
            <div class="flex items-center gap-4">
              <comboboxEnhanced 
                ...
                placeholder="Seleccione a factura, se aplicável..."
                class="flex-1"
              />
...
const form = useForm({
  ...
  country_origin_id: {
    value: props.record.data?.country_origin_id,
    label: props.record.data?.country_origin
  },
  origin_city: props.record.data?.origin_city,
  country_destination_id: {
    value: props.record.data?.country_destination_id,
    label: props.record.data?.country_destination
  },
  destination_city: props.record.data?.destination_city,
  expedition_date: props.record.data?.expedition_date,
  expedition_location: props.record.data?.expedition_location,
  date: props.record.data?.date,
  authorized_personnel: props.record.data?.authorized_personnel,
  invoiced: props.record.data?.invoiced,
...
const submit = () => {
  form.put(route('exportcertificates.update', { exportcertificate: props.record.data?.id}), {
    preserveScroll: true,
    preserveState: false,
    onSuccess: () => {
      form.reset();
