        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-10">
          ...
          <div class="sm:col-span-2">
            <div class="mt-8 flex items-center justify-end">
              <button v-if="!form.converted_to_invoice" @click="convertToInvoice" class="inline-flex justify-center rounded-md bg-blue-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900">{{ $t('gestlab.general.labels.quotes.convert_to_invoice') }}</button>
            </div>
          </div>
