      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-2 text-gray-600">
            {{ $t('gestlab.general.labels.paid_services.page_create_description') }}
        ...
        <div class="flex items-center gap-3">
          <span class="inline-flex items-center rounded-full bg-blue-50 px-3 py-1 text-sm font-medium text-blue-900 ring-1 ring-inset ring-blue-700/10">
            {{ $t('gestlab.general.labels.paid_services.new_product') }}
          </span>
        </div>
      </div>
    </div>
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            ...
            >
              <CubeIcon class="h-5 w-5" />
              {{ form.processing ? $t('gestlab.general.labels.paid_services.processing') : $t('gestlab.general.buttons.submit') }}
            </button>
