...
<div class="border-b border-gray-200 pb-5">
    ...
    <p class="mt-2 max-w-4xl text-sm text-gray-500">{{ $t('gestlab.general.labels.contract_guides.page_create_description') }} {{ form.name }}</p>
</div>
...
<form @submit.prevent>
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-10">
          ...
          <div class="sm:col-span-2">
            <label for="collection_point" class="block text-sm font-medium leading-6 text-gray-900">{{ $t('gestlab.general.labels.contract_guides.collection_point') }}</label>
            <div class="mt-2">
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-600">{{ $t('gestlab.general.labels.contract_guides.products_tagline') }} {{ form.name }}</p>
