...
let submit = () => {
    ...
    if(!form.id) {
      form.post(route('proposalcomplianceagreements.store'), {
          preserveScroll: true,
          preserveState: false,
          onSuccess: () => {
            openslideover.value = false;
      ...
      form.put(route('proposalcomplianceagreements.update',{agreement: form.id}), {
          preserveScroll: true,
          preserveState: false,
          onSuccess: () => {
            openslideover.value = false;
...
<div class="border-b border-gray-200 pb-5">
    <h3 class="text-base font-semibold leading-6 text-gray-900">{{ $t('gestlab.general.labels.proposal_compliance_agreements.page_title') }}</h3>
</div>
