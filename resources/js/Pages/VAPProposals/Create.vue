          ...
          <div class="space-y-4">
            ...
            <div class="border-t border-gray-200 pt-4">
              ...
              <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                  <span class="text-gray-600">{{ $t('gestlab.general.labels.vap_proposals.create.items.discount') }}</span>
                ...
                <div class="flex justify-between text-sm">
                  <span class="text-gray-600">{{ $t('gestlab.general.labels.vap_proposals.create.items.total') }}</span>
...
function loadWarehouses(query, setOptions) {
  fetch('/warehouses/getWarehouse?q=' + query + '&customer_id=' + form.customer_id)
    .then(response => response.json())
    .then(results => {
      setOptions(
        results.map(result => ({
