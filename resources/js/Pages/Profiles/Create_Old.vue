  ...
  <form @submit.prevent>
    <div class="space-y-12">
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-10">
        ...
        <div class="sm:col-span-2 sm:col-start-1">
          <label
            ...
            >{{ $t("gestlab.general.labels.profiles.name") }}</label
          >
          <div class="mt-2">
            <input
              v-model="form.name"
        ...
        <div class="sm:col-span-2">
          <label
            for="code"
            class="block text-sm font-medium leading-6 text-gray-900"
            >{{ $t("gestlab.general.labels.profiles.code") }}</label
          >
          <div class="mt-2">
            <input
              v-model="form.code"
        ...
        <div class="sm:col-span-2">
          <label
            for="description"
            class="block text-sm font-medium leading-6 text-gray-900"
            >{{ $t("gestlab.general.labels.profiles.description") }}</label
          >
          <div class="mt-2">
            <input
        ...
        <div class="sm:col-span-2">
          <label
            for="price"
            class="block text-sm font-medium leading-6 text-gray-900"
            >{{ $t("gestlab.general.labels.profiles.price") }}</label
          >
          <div class="mt-2">
            <input
              disabled
        ...
        <div class="sm:col-span-2">
          <label
            for="category_id"
            class="block text-sm font-medium leading-6 text-gray-900"
            >{{ $t("gestlab.general.labels.profiles.category_id_1") }}</label
          >
          <div class="mt-2">
            <combobox
      ...
      <div class="border-b border-gray-900/10 pb-12">
        <h2
          class="text-base font-semibold leading-7 text-gray-900 flex items-center"
        >
          {{ form.parameters.length }}
          {{ $t("gestlab.general.labels.profiles.items") }}
          <button
            @click="addParameter"
      ...
      >
        <li
          v-for="(parameter, parameterIndex) in form.parameters"
          :key="parameter.value"
        ...
        >
          <div
            class="flex items-center gap-x-4 border-b border-gray-900/5 bg-blue-900 p-3 text-white"
          >
            <div class="text-sm font-medium leading-6 text-gray-900 text-white">
              <ClipboardDocumentCheckIcon class="h-5 w-5" />
            </div>
            {{ parameterIndex + 1 }}º
            {{ $t("gestlab.general.labels.profiles.parameter") }}

            <button
              @click="removeParameter(parameterIndex)"
              class="transform transition-all duration-200 hover:scale-150 ml-auto"
            >
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.parameter_id`]
                      "
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label
                    for="unit_id"
                    class="block text-sm font-medium leading-6 text-gray-900"
                    >{{ $t("gestlab.general.labels.profiles.unit_id") }}</label
                  >
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.unit_id`]
                      "
                  ...
                  <p
                    v-if="form.errors[`parameters.${parameterIndex}.unit_id`]"
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
                    {{ form.errors[`parameters.${parameterIndex}.unit_id`] }}
             ...
             <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                ...
                <div class="sm:col-span-full">
                  <input
                    disabled
                    v-model="form.parameters[parameterIndex].optimal_analysis_time"
                    type="text"
                    :name="`item-${parameterIndex}-error`"
                    :id="`item-${parameterIndex}-error`"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-900 sm:text-sm sm:leading-6"
                  />
                  <p
                    v-if="form.errors[`parameters.${parameterIndex}.optimal_analysis_time`]"
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
                    {{ form.errors[`parameters.${parameterIndex}.optimal_analysis_time`] }}
                  </p>
                </div>
              </dd>
            </div>
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.protocol_id`]
                      "
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.standard_id`]
                      "
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label
                    for="nwp_id"
                    class="block text-sm font-medium leading-6 text-gray-900"
                    >{{ $t("gestlab.general.labels.profiles.nwp_id") }}</label
                  >
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.nwp_id`]
                      "
                  ...
                  <p
                    v-if="form.errors[`parameters.${parameterIndex}.nwp_id`]"
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
                    {{ form.errors[`parameters.${parameterIndex}.nwp_id`] }}
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <p
                    v-if="
                      form.errors[`parameters.${parameterIndex}.min_ref_value`]
                    "
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <p
                    v-if="
                      form.errors[`parameters.${parameterIndex}.max_ref_value`]
                    "
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
            ...
            <div class="gap-x-4 py-3">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <p
                    v-if="form.errors[`parameters.${parameterIndex}.ref_val_origin`]"
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
                    {{
                      form.errors[`parameters.${parameterIndex}.ref_val_origin`]
                    }}
                  </p>
                </div>
              </dd>
            ...
            <div class="gap-x-4 py-3" v-if="form?.category_id?.value === 2">
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <p
                    v-if="form.errors[`parameters.${parameterIndex}.dilutions`]"
                    class="mt-2 text-xs text-red-600"
                    :id="`item-${parameterIndex}-error`"
                  >
                    {{ form.errors[`parameters.${parameterIndex}.dilutions`] }}
                  </p>
                </div>
              </dd>
            </div>
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  ...
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.category_id`]
                      "
              ...
              <dd class="text-gray-700">
                <div class="sm:col-span-full">
                  <label
                    ...
                    class="block text-sm font-medium leading-6 text-gray-900"
                    >{{
                      $t("gestlab.general.labels.profiles.formula_id")
                    }}</label
                  >
                  <div class="mt-2">
                    <combobox
                      :hasError="
                        form.errors[`parameters.${parameterIndex}.formula_id`]
                      "
                      v-model="parameter.formula_id"
      ...
      <p v-if="form.errors.parameters" class="mt-2 text-xs text-red-600">
        {{ form.errors.parameters }}
      </p>
    </div>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
      ...
      <button
        ...
        class="block justify-center rounded-md bg-blue-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-800"
      >
                        ...
                        <dl class="divide-y divide-gray-100">
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.category_id",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.parameter_id",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.protocol_id",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.standard_id",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.min_ref_value",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.max_ref_value",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            >
                              {{
                                $t(
                                  "gestlab.general.labels.profiles.ref_val_origin",
                                )
                              }}
                            </dt>
                            <dd
                          ...
                          >
                            ...
                            >
                              {{
                                form.category_id == 2 ? $t("gestlab.general.labels.profiles.dilutions") : 'Analitos'
                              }}
                            </dt>
                            <dd
                              class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0"
