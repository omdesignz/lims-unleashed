    ...
    <div class="space-y-6">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-10">
          ...
          <div class="sm:col-span-2 sm:col-start-1">
            ...
            <div class="mt-2">
              <comboboxEnhanced :hasError="form.errors.type_id" v-model="form.type_id" :load-options="loadInvoiceCategories" @update:model-value=""/>
            </div>
          ...
          <div class="sm:col-span-2">
            ...
            <div class="mt-2">
              <comboboxEnhanced :hasError="form.errors.warehouse_id" v-model="form.warehouse_id" :load-options="loadWarehouses"/>
            </div>
      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <p class="mt-1 text-sm leading-6 text-gray-600">{{ $t('gestlab.general.labels.invoices.items_tagline') }} {{ form?.inv_no }}</p>
      </div>
