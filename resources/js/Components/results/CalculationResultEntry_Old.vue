...
const emit = defineEmits(['calculatedResults'])

const results = ref({})
const overrides = ref({})
const uncertaintyValues = ref({}) // ✅ NEW: State for uncertainty values
...
<template>
  <div class="result-entry-container space-y-6">
    <div class="bg-white p-6 rounded-lg shadow">
      <h2 class="text-xl font-bold text-gray-900">Amostra #{{ sample }}</h2>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
          ...
          <div v-for="parameter in allCalculatedParameters" :key="parameter.parameter_id.code"
            ...
            <div>
                ...
                <input v-model="uncertaintyValues[parameter.parameter_id.code]"
                    type="number"
                    step="0.0001"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Ex: 0.1">
