...
watch(
    ...
    (record) => {
        if (record) {
            form.verified_on_behalf_of = record?.data?.verified_on_behalf_of
...
function updateRecord(e) {
    form.post(props.url, {certificate: form.id, signature: form.signature, approve_on_behalf_of: form.approve_on_behalf_of, verified_on_behalf_of: form.verified_on_behalf_of}), {
