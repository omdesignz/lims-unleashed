...
<head>
    ...
    <style>
        ...
        @page {
            margin: 105mm 10mm 82mm 10mm; /* Reduced side margins to 10mm */
            header: page-header;
            footer: page-footer;
            margin-header: 10mm;
            margin-footer: 15mm;
        ...
        /* Add this for better table fitting */
        table {
            table-layout: auto;
            width: 100%;
        }
...
<htmlpageheader name="page-header">
    <!-- No padding wrapper needed in header - let @page margin handle it -->
        ...
        <tr>
            <td style="background: linear-gradient(to right, #1e3a8a, #1e40af); color: white; padding: 12px 15px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <div style="font-size: 15px; font-weight: 600; color: white; font-weight:bold;">{!! $model?->invoice_category?->description !!}</div>
                        </td>
                        <td align="right">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="25%" valign="top">
                            ...
                            <div style="font-size: 12px; font-weight: 600; color: #111827;">{!! $model->inv_no !!}</div>
                        </td>
                        <td width="25%" valign="top">
                            <div style="font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 3px;">LOTE</div>
                            <div style="font-size: 12px; font-weight: 600; color: #111827;">{!! $model->bl_ref ?? 'N/A' !!}</div>
                        </td>
                        <td width="25%" valign="top">
                        ...
                        <td width="25%" valign="top">
                            <div style="font-size: 11px; font-weight: 500; color: #374151; margin-bottom: 3px;">Página</div>
...
<htmlpagefooter name="page-footer">
    <!-- No padding wrapper in footer either -->
    @if(count($model->items->chunk(12)) < 2)
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 15px;">
            <tr>
                <td>
                    <div style="font-size: 11px; color: #6b7280; margin-bottom: 10px;">
                        <span style="font-weight: 500;">Observações:</span> {!! $model->obs !!}
                    </div>
        ...
        <tr>
            <td>
                <div style="font-size: 6pt; color: #6b7280;">
                    <p style="margin: 0 0 5px 0;font-size: 8pt;">Os bens/serviços foram colocados à disposição do adquirente na data do documento. O pagamento desta factura deve ser efectuado por meio do RUPE (Referência Única de Pagamento ao Estado).</p>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
...
<!-- Main Content - No wrapper div, let @page margin handle it -->
@php
    $carry = null; 
    $chunk_total = null;
            ...
            @foreach($chunk as $item)
                <tr>
                    ...
                    <td style="text-align: left; padding: 10px 8px; border-bottom: 1px solid #f3f4f6;">
                        ...
                        @if($item->itemable)
                            <div style="font-size: 9px; color: #6b7280;">(CL: {!! $item->itemable->code->code !!} DU: {!! $item->itemable->du_no !!})</div>
                        @endif
                    </td>
                        ...
                        <td style="padding: 15px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td valign="top" style="padding-right: 15px;">
                                        <!-- Tax Summary -->
                                        <table width="100%" cellpadding="0" cellspacing="0" style="background: white; border: 1px solid #e5e7eb; border-radius: 8px;">
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding: 15px;">
                                                    ...
                                                    @if($model->items()->whereChargeTax(0)->count() > 0)
                                                    <div style="font-size: 10px; color: #6b7280; margin-top: 10px; padding: 8px; background-color: #f9fafb; border-radius: 6px;">
                                                        {!! $model->items()->where('charge_tax', 0)->first()->exemption_code . ' - ' . $model->items()->where('charge_tax', false)->first()->exemption->reason !!}
                                                    </div>
                                                    @endif
                                                </td>
                                    ...
                                    <td width="45%" valign="top">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 15px;">
                                            <tr>
                                                <td>
                                                    <div style="font-size: 12px; font-weight: 600; color: #111827; margin-bottom: 12px;">Resumo Financeiro</div>
                                                        ...
                                                        <tr>
                                                            <td style="padding-top: 15px; border-top: 2px solid #1e3a8a;">
                                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td>
                                                                            <div style="font-size: 12px; font-weight: 600; color: #111827;">Total a Pagar</div>
                                                                            <div style="font-size: 10px; color: #6b7280;">AKZ</div>
                                                                        </td>
                                                                        <td align="right">
                                                                            <div style="font-size: 18px; font-weight: 700; color: #1e3a8a;">{!! number_format($model->total, 2, ',', '.') !!}</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
