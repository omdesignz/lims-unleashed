...
<p style="font-size:9px;padding:5px 5px;">Observações: {!! $model->obs !!}</p>
        ...
        <tbody>
            ...
            @foreach($chunk as $item)
                <tr>
                    ...
                    {!! $item->item_description !!} {!! ($item->itemable ? '(CL: ' . $item->itemable->code->code . ' DU: ' . $item->itemable->du_no . ')' : '') !!}
