        ...
        <tr>
            <td style="background: linear-gradient(to right, #1e3a8a, #1e40af); color: white; padding: 12px 15px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <div style="font-size: 15px; font-weight: 600; color: white; font-weight: bold;">Nota de Crédito</div>
                        </td>
                        <td align="right">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="25%" valign="top">
                            ...
                            <div style="font-size: 12px; font-weight: 600; color: #111827;">{!! $model->note_no !!}</div>
                        </td>
                        <td width="25%" valign="top">
                            <div style="font-size: 11px; font-weight: bold; color: #374151; margin-bottom: 3px;">Documento</div>
                            <div style="font-size: 12px; font-weight: 600; color: #111827;">Referente à factura {!! $model->invoice->inv_no ?? $model->inv_no !!}</div>
                        </td>
                        <td width="25%" valign="top">
                        ...
                        <td width="25%" valign="top">
                            <div style="font-size: 11px; font-weight: bold; color: #374151; margin-bottom: 3px;">Motivo</div>
                            <div style="font-size: 12px; font-weight: 600; color: #111827;">
                                {!! ($model->reason == 'R' ? 'Rectificação' : 'Anulação') !!}
                            </div>
                        </td>
                    </tr>
                </table>
...
<htmlpagefooter name="page-footer">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td width="33%" valign="top" style="padding-right: 10px;">
                                                                    <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 4px;">TAXA DO IMPOSTO</div>
                                                                ...
                                                                <td width="33%" valign="top" style="padding: 0 10px;">
                                                                    <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 4px;">BASE DE INCIDÊNCIA</div>
                                                                    <div style="font-size: 13px; font-weight: 600; color: #1e3a8a;">
                                                                ...
                                                                <td width="33%" valign="top" style="padding-left: 10px;">
                                                                    <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 4px;">VALOR DO IMPOSTO</div>
                                                                    <div style="font-size: 13px; font-weight: 600; color: #1e3a8a;">
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0" style="background: white; border: 1px solid #e5e7eb; border-radius: 6px; padding: 12px;">
                                                <tr>
                                                    <td style="padding-bottom: 8px;">
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td><div style="font-size: 11px; font-weight: bold; color: #374151;">Total Ilíquido</div></td>
                                                ...
                                                <tr>
                                                    <td style="padding: 8px 0; border-top: 1px solid #f3f4f6;">
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td><div style="font-size: 11px; font-weight: bold; color: #374151;">Descontos</div></td>
                                                ...
                                                <tr>
                                                    <td style="padding: 8px 0; border-top: 1px solid #f3f4f6;">
                                                        <table width="100%" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td><div style="font-size: 11px; font-weight: bold; color: #374151;">Valor do Imposto (IVA)</div></td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border-top: 1px solid #e5e7eb; padding-top: 12px; margin-top: 10px;">
        <tr>
            <td>
                <!-- Client Acknowledgment Line -->
                <div style="font-size: 10px; color: #6b7280; line-height: 1.4; margin-bottom: 8px; padding: 8px; background-color: #f9fafb; border-radius: 4px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="font-size: 8pt;">
                                {!! $model->unique_hash[0] . $model->unique_hash[10] . $model->unique_hash[20] . $model->unique_hash[30] !!} - Processado por programa validado N. <span style="font-weight: bold;">{!! $settings->app_agt_validation_number !!}</span>
                            </td>
        ...
        <tbody>
            @foreach($chunk as $item)
                <tr>
                    ...
                    <td style="text-align: left; padding: 10px 8px; border-bottom: 1px solid #f3f4f6;">
                        ...
                        @if($item->itemable)
                            <div style="font-size: 9px; color: #6b7280;">
                                (CL: {!! $item->itemable->code->description !!} DU: {!! $item->itemable->du_no !!})
                            </div>
                        @endif
                    </td>
                    ...
                    <td style="font-size: 10px; font-weight: bold; color: #374151; text-align: right; padding: 10px 8px; border-bottom: 1px solid #f3f4f6;">{!! number_format($item->unit_price + $item->discount_amount, 2, ',', '.') !!}</td>
                    ...
                    <td style="text-align: right; padding: 10px 8px; border-bottom: 1px solid #f3f4f6;">
                        <div style="font-size: 10px; font-weight: bold; color: #374151;">{!! number_format($item->tax_percentage, 2, ',', '.') !!}%</div>
                        @if(!$item->charge_tax)
...
@if(count($chunks) > 1)
    <!-- Final Summary Section for Multi-page Credit Notes -->
                                            ...
                                            <tr>
                                                <td style="padding: 15px; background: #f9fafb; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td width="33%" valign="top" style="padding-right: 10px;">
                                                                <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 6px;">TAXA DO IMPOSTO</div>
                                                                <div style="font-size: 14px; font-weight: 600; color: #1e3a8a;">
                                                                    {!! ($model->items()->whereChargeTax(1)->count() > 0 ? number_format($model->items()->whereChargeTax(1)->first()->tax_percentage, 2, ',', '.') : number_format(0, 2, ',', '.')) !!}%
                                                                </div>
                                                            </td>
                                                            <td width="33%" valign="top" style="padding: 0 10px;">
                                                                <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 6px;">BASE DE INCIDÊNCIA</div>
                                                                <div style="font-size: 14px; font-weight: 600; color: #1e3a8a;">
                                                                    {!! number_format($model->items->sum(function($it){if($it->charge_tax){return $it->total;}}), 2, ',', '.') !!}
                                                                </div>
                                                            </td>
                                                            <td width="33%" valign="top" style="padding-left: 10px;">
                                                                <div style="font-size: 10px; font-weight: bold; color: #374151; margin-bottom: 6px;">VALOR DO IMPOSTO</div>
                                                                <div style="font-size: 14px; font-weight: 600; color: #1e3a8a;">
                                                                    {!! number_format($model->items->sum('tax_amount'), 2, ',', '.') !!}
                                                                </div>
                                                            </td>
