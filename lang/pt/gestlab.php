    ...
    'general' => [
        ...
        'labels' => [
            ...
            'signature' => [
                ...
                'empty_error' => 'Desenhe uma assinatura antes de continuar.',
            ...
            'vap_proposals' => [
                ...
                'form' => [
                    'invalid_json_response' => 'Resposta inválida (:status)',
                    'load_parameters_error' => 'Não foi possível carregar os parâmetros deste código laboratorial.',
                    'duplicate_suffix' => '(Cópia)',
                    'minimum_one_item' => 'A proposta deve ter pelo menos um item.',
                    'reset_create_confirm' => 'Clique novamente em Repor para descartar as alterações deste formulário.',
                    'draft_unavailable' => 'O modo rascunho ficará disponível quando existir persistência dedicada para propostas incompletas.',
                    'required_fields' => 'Preencha os campos obrigatórios e adicione pelo menos um item.',
                    'save_error' => 'Não foi possível guardar a proposta. Revise os campos assinalados.',
                    'reset_edit_confirm' => 'Clique novamente em Descartar alterações para restaurar os valores originais.',
                    'update_error' => 'Não foi possível atualizar a proposta. Revise os campos assinalados.',
                ],
            ...
            'vap_proposal_templates' => [
                ...
                'list' => [
                    ...
                    'summary' => ':from-:to de :total modelos',
                ],
                ...
                'studio' => [
                    ...
                    'media_picker' => [
                        'eyebrow' => 'Galeria documental',
                        'title' => 'Biblioteca multimédia',
                        'description' => 'Pesquise e aplique fundos, imagens, carimbos ou assinaturas sem copiar URLs manualmente.',
                        'close' => 'Fechar',
                        'add_title' => 'Adicionar multimédia ao documento',
                        ...
                        'search_placeholder' => 'Pesquisar por nome, origem, autor, tipo ou URL',
                        'target_label' => 'Alvo: :target',
                        'empty' => 'Nenhum ficheiro encontrado. Carregue uma imagem, assinatura, gráfico, fundo ou carimbo para continuar.',
                        'target' => [
                            'document_background' => 'Fundo do documento',
                            'asset_url' => 'URL do recurso do layout',
                            'selected_block' => 'Bloco seleccionado · :field',
                            'selected' => 'Alvo seleccionado',
                        ],
                        'fields' => [
                            'image_url' => 'Imagem / carimbo',
            ...
            'vap_report_studios' => [
                ...
                'studio' => [
                    ...
                    'media_picker' => [
                        'eyebrow' => 'Galeria documental',
                        'title' => 'Biblioteca multimédia',
                        'description' => 'Pesquise e aplique fundos, imagens, gráficos, assinaturas e carimbos sem copiar URLs manualmente.',
                        'close' => 'Fechar',
                        'add_title' => 'Carregar e aplicar multimédia',
                        'add_description' => 'Arraste SVG, PNG, JPEG, WebP, GIF ou AVIF para aplicar ao alvo actual: fundo do documento, URL do layout ou bloco seleccionado.',
                        'allowed_badge' => 'SVG · PNG · JPEG · WebP · AVIF',
                        'allowed_types_error' => 'Use SVG, PNG, JPEG, WebP, GIF ou AVIF.',
                        ...
                        'choose_file' => 'Escolher ficheiro',
                        'search_placeholder' => 'Pesquisar por nome, origem, autor, tipo ou URL',
                        'manual_advanced' => 'Ligação manual avançada',
            ...
            'backups' => [
                ...
                'load_error' => 'Não foi possível actualizar os dados de cópia de segurança. Tente novamente dentro de alguns instantes.',
            ...
            'commercial_documents' => [
                'commercial_area' => 'Comercial',
                'treasury_area' => 'Tesouraria',
                'records' => 'Registos',
                'flow' => 'Fluxo',
            ],
            'invoices' => [
                'page_title' => 'Facturas',
                'index_description' => 'Emissão, cobrança e acompanhamento fiscal com uma visão clara do estado das facturas.',
                'index_flow' => 'Facturação',
            ...
            'quotes' => [
                ...
                'index_description' => 'Prepare propostas comerciais, acompanhe aprovações e converta documentos sem perder rastreabilidade.',
                'index_flow' => 'Propostas',
            ...
            'credit_notes' => [
                ...
                'index_description' => 'Controle rectificações, créditos e documentos fiscais relacionados com facturas já emitidas.',
                'index_flow' => 'Crédito',
            ...
            'receipts' => [
                'page_title' => 'Recibos',
                'index_description' => 'Registe pagamentos, mantenha evidência financeira e relacione recibos às facturas certas.',
                'index_flow' => 'Cobrança',
            ...
            'vap_labels' => [
                ...
                'qr_code_description' => 'Código verificável para rastrear a etiqueta, a amostra ou o documento associado.',
                'barcode_description' => 'Código linear para leitura rápida em armazém, recepção ou bancada técnica.',
                'logo_description' => '',
                ...
                'index' => [
                    ...
                    'description' => 'Desenhe, controle e imprima etiquetas para amostras, equipamentos, reagentes e materiais com dimensões, cores, QR, estado e laboratório associados.',
                    'filters_eyebrow' => 'Pesquisa e filtros',
                    'filters_title' => 'Encontre a etiqueta certa antes de imprimir',
                    'filters_description' => 'Filtre por tipo, laboratório e estado para reduzir erros de impressão e reutilizar modelos aprovados.',
                    'gallery_eyebrow' => 'Galeria operacional',
                    'gallery_title' => 'Pré-visualize antes de editar ou imprimir',
                    'gallery_description' => 'As etiquetas aparecem como cartões físicos para facilitar a validação visual de cor, dimensão, tipo e destino.',
                    'records_eyebrow' => 'Biblioteca de etiquetas',
                    'result_summary' => ':count etiquetas',
                    'no_lab' => 'Sem laboratório definido',
                    'stats_active' => 'Activas',
                    'stats_active_hint' => 'Etiquetas disponíveis para uso e impressão.',
                    'stats_types' => 'Tipos controlados',
                    'stats_types_hint' => 'Famílias de etiquetas configuradas neste workspace.',
                    'stats_scope' => 'Filtro actual',
                    'stats_scope_hint' => 'Escopo actualmente aplicado à listagem.',
                ],
                'editor' => [
                    'identity_title' => 'Identidade e dimensão da etiqueta',
                    'identity_description' => 'Defina o nome, o tipo, a origem operacional e o tamanho físico que será respeitado no PDF e na impressão.',
                    'source_title' => 'Origem operacional da etiqueta',
                    'source_record' => 'Registo de origem',
                    'select_source' => 'Selecionar origem',
                    'source_sample' => 'Amostra',
                    'source_sample_description' => 'Recepção, retenção, QR e rastreabilidade analítica.',
                    'source_equipment' => 'Equipamento',
                    'source_equipment_description' => 'Identificação, estado metrológico e manutenção.',
                    'source_reagent' => 'Reagente / material',
                    'source_reagent_description' => 'Lote, validade, armazenagem e stock.',
                    'source_hint' => 'Esta etiqueta pode ser gerada automaticamente a partir do registo selecionado, reutilizando código, lote, cliente, armazém e datas relevantes.',
                    'content_title' => 'Conteúdo dinâmico e variáveis',
                    'content_description' => 'Use variáveis controladas para manter a etiqueta ligada à amostra, equipamento ou material sem digitação manual repetida.',
                    'appearance_title' => 'Aparência pronta para impressão',
                    'traceability_title' => 'Elementos de rastreabilidade',
                    'traceability_description' => 'Inclua QR, código de barras, logótipo ou selo para verificação e controlo físico.',
                    'logo_title' => 'Logótipo ou imagem auxiliar',
                    'logo_description' => 'Use uma referência de media já carregada para incluir logo, selo ou marca visual na etiqueta.',
                    'preview_title' => 'Pré-visualização física',
                    'template_title' => 'Modelos aprovados',
                ],
                'show' => [
                    'eyebrow' => 'Etiqueta controlada',
                    'pdf_card' => 'PDF premium',
                    'chrome_active' => 'Chrome PDF activo',
                    'mpdf_active' => 'Fallback mPDF activo',
                    'pdf_description' => 'Renderização configurada para preservar dimensões, marcas de corte e composição visual da etiqueta.',
                    'dimensions_hint' => 'Tamanho personalizado respeitado no preview, PDF singular e lote.',
                    'traceability_card' => 'Rastreabilidade',
                    'traceability_hint' => 'Elementos técnicos preparados para impressão operacional.',
                    'preview_title' => 'Pré-visualização antes da impressão',
                    'preview_description' => 'A composição abaixo usa as mesmas dimensões, cores, bordas e elementos persistidos para a geração PDF.',
                    'print_title' => 'Impressão singular e em lote',
                    'print_description' => 'Configure dados variáveis, marcas de corte e paginação antes de gerar etiquetas com o motor PDF.',
                ],
                ...
                'buttons' => [
                    ...
                    'mark_featured' => 'Assinalar Destaque',
                    'edit' => 'Modificar',
                    'delete' => 'Eliminar',
                    'activate' => 'Activar',
            ...
            'quality_certificates' => [
                ...
                'enable_on_behalf' => 'Activar assinatura em nome de outra pessoa',
                'disable_on_behalf' => 'Desactivar assinatura em nome de outra pessoa',
                'verify_certificate' => 'Verificar Boletim',
                'validate_certificate' => 'Validar Boletim',
                'verify_description' => 'Assine digitalmente para verificar a evidência técnica deste boletim.',
                'validate_description' => 'Assine digitalmente para aprovar e validar a emissão deste boletim.',
                'verify_signature' => 'Assinatura de Verificação',
                'validate_signature' => 'Assinatura de Validação',
