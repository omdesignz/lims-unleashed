...
class CreditNoteRequest extends FormRequest
{
    ...
    {
        return [
            'invoice_id' => trans('gestlab.general.labels.credit_notes.invoice_id'),
            'customer_id' => trans('gestlab.general.labels.credit_notes.customer_id'),
            'warehouse_id' => trans('gestlab.general.labels.credit_notes.warehouse_id'),
            'internal_ref' => trans('gestlab.general.labels.credit_notes.internal_ref'),
            'reason' => trans('gestlab.general.labels.credit_notes.reason'),
            'obs' => trans('gestlab.general.labels.credit_notes.obs'),
            'items' => trans('gestlab.general.labels.credit_notes.items'),
            'items.*.note_id' => trans('gestlab.general.labels.credit_notes.note_id'),
            'items.*.unit_id' => trans('gestlab.general.labels.credit_notes.unit_id'),
            'items.*.exemption_id' => trans('gestlab.general.labels.credit_notes.exemption_id'),
            'items.*.discount_id' => trans('gestlab.general.labels.credit_notes.discount_id'),
            'items.*.item_id' => trans('gestlab.general.labels.credit_notes.item_id'),
            'items.*.qty' => trans('gestlab.general.labels.credit_notes.qty'),
            'items.*.unit_price' => trans('gestlab.general.labels.credit_notes.unit_price'),
            'items.*.total' => trans('gestlab.general.labels.credit_notes.total'),
            'items.*.discount_percentage' => trans('gestlab.general.labels.credit_notes.discount_percentage'),
            'items.*.tax_percentage' => trans('gestlab.general.labels.credit_notes.tax_percentage'),
            'items.*.charge_tax' => trans('gestlab.general.labels.credit_notes.charge_tax'),
        ];
    }
...
public function messages(): array
{
    ...
    public function prepareForValidation()
    {
        ...
        // dd(request()->reason = CreditNote::REASON_RECTIFICATION ? 'equals R' : 'Nope');
        ...
        if ($this->isMethod('post')) {
            ...
            $this->merge([
                ...
                'is_original' => true,
                'exported_saft' => false,
                'note_month' => now()->format('Y'),
                'invoice_id' => !is_null(request()->invoice_id) ? request()->invoice_id['value'] : null,
                'reason' => !is_null(request()->reason) ? request()->reason['value'] : null,
