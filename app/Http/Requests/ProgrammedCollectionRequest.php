...
class ProgrammedCollectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        if ($this->isMethod('post')) {
            $rules = [
                ...
                'vehicle_reference' => 'nullable',
                'collection_location' => 'nullable',
            ...
            $rules = [
                ...
                'pack_id' => 'nullable|exists:packaging_categories,id',
    ...
    {
        return [
            'customer_id' => trans('gestlab.general.labels.programmed_collections.customer_id'),
            'warehouse_id' => trans('gestlab.general.labels.programmed_collections.warehouse_id'),
            'products' => trans('gestlab.general.labels.programmed_collections.products'),
            'products.*.product_id' => trans('gestlab.general.labels.programmed_collections.product_id'),
            'products.*.comercial_brand' => trans('gestlab.general.labels.programmed_collections.comercial_brand'),
            'products.*.result_id' => trans('gestlab.general.labels.programmed_collections.result_id'),
            'products.*.pack_id' => trans('gestlab.general.labels.programmed_collections.pack_id'),
            'products.*.vehicle_id' => trans('gestlab.general.labels.programmed_collections.vehicle_id'),
            'products.*.collection_date' => trans('gestlab.general.labels.programmed_collections.collection_date'),
            'products.*.temperature_id' => trans('gestlab.general.labels.programmed_collections.temperature_id'),
            'products.*.temperature_value' => trans('gestlab.general.labels.programmed_collections.temperature_value'),
            'products.*.collected_by_lab' => trans('gestlab.general.labels.programmed_collections.collected_by_lab'),
            'products.*.lot' => trans('gestlab.general.labels.programmed_collections.lot'),
            'products.*.obs' => trans('gestlab.general.labels.programmed_collections.obs'),
            ...
            'products.*.bl' => trans('gestlab.general.labels.programmed_collections.bl'),
            'products.*.term_no' => trans('gestlab.general.labels.programmed_collections.term_no'),
            'products.*.container_no' => trans('gestlab.general.labels.programmed_collections.container_no'),
            'products.*.expiry_date' => trans('gestlab.general.labels.programmed_collections.expiry_date'),
            'products.*.production_date' => trans('gestlab.general.labels.programmed_collections.production_date'),
            'products.*.qty' => trans('gestlab.general.labels.programmed_collections.qty'),
            'products.*.origin' => trans('gestlab.general.labels.programmed_collections.origin'),
            'products.*.location' => trans('gestlab.general.labels.programmed_collections.location'),
            'products.*.owner_id' => trans('gestlab.general.labels.programmed_collections.owner_id'),
        ];
    }
    ...
    public function prepareForValidation()
    {
        ...
        if ($this->isMethod('post')) {
            ...
            $this->merge([
                ...
                'collected_qty' => request()->collected_qty ?? null,
                'lot' => request()->lot ?? null,
                'origin' => request()->origin ?? null,
                'location' => request()->location ?? null,
                'bl' => request()->bl ?? null,
                'temperature_value' => request()->temperature_value ?? null,
