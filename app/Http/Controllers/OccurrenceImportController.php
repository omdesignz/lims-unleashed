...
class OccurrenceImportController extends Controller
{
    ...
    {
        return inertia('Occurrences/occurrences-import-form');
    }
    ...
    public function upload(Request $request)
    {
        ...
        //     // Delete uploaded file if header invalid
        //     Storage::delete($path);

        //     return back()->withErrors([
        //         'file' => 'CSV header columns do not match the expected format. Please use the correct template.',
        //     ]);
        // }
        ...
        // Create a LazyCollection to stream CSV rows without loading entire file into memory
