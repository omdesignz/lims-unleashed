...
class EquipmentImportController extends Controller
{
    ...
    {
        return inertia('InventoryItems/equipments-import-form');
    }
    ...
    public function upload(Request $request)
    {
        ...
        //     $jobs[] = new ImportEquipmentsChunk($chunk->all());
        // }
        ...
        return redirect()->route('equipments.import.progress', ['batchId' => $batch->id]);
