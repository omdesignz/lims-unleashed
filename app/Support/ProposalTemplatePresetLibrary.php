            ...
            'layout_schema' => self::layout(
                ...
                canvasBlocks: [
                    self::canvasBlock([
                        ...
                        'surface' => 'content',
                        'content_html' => '<div style="font-size:10px; letter-spacing:0.22em; text-transform:uppercase; color:#d8b85f;">{{document_code}}</div><div style="margin-top:12px; font-size:26px; line-height:1.15; font-weight:700;">Proposta para {customer_name}</div><div style="margin-top:12px; font-size:12px;">Âmbito técnico, investimento e condições de aceitação num documento único.</div>',
                        'x' => 0,
                        'y' => 0,
                        'width' => 100,
                        'min_height' => 155,
                    ...
                    self::chartBlock('commercial-scope-chart', 'Resumo visual do âmbito', 5, 76, 'following'),
                ],
...
HTML,
    ...
    private static function layout(
        ...
        return [
            ...
            'variable_catalog' => [
                ...
                ['value' => '{verification_url}', 'label' => 'Ligação de verificação'],
                ['value' => '{proposal_authenticity}', 'label' => 'QR e autenticidade'],
                ['value' => '{proposal_acceptance_evidence}', 'label' => 'Evidência de aceite'],
            ],
     ...
     * @return array<string, mixed>
     */
    private static function chartBlock(string $id, string $title, float $x, float $y, string $pageScope): array
    {
        return self::canvasBlock([
            ...
            'border_radius' => 22,
            'chart_title' => $title,
            'chart_caption' => 'Visão visual do âmbito, amostras e serviços associados à proposta.',
            'chart_type' => 'bar',
